...
public class Utils {
   ...
   /*
    ...
    public WebDriver setupWebDriver() {
        ...
        {
            String msedgeDriverPath = null;

            if (this.getOsName().equalsIgnoreCase("Windows")) {
                msedgeDriverPath = windowsDriverLocation + "msedgedriver.exe";
            } else if (this.getOsName().equalsIgnoreCase("Mac OS")) {
                msedgeDriverPath = macDriverLocation + "msedgedriver";
            } else if (this.getOsName().equalsIgnoreCase("Linux")) {
                msedgeDriverPath = linuxDriverLocation + "msedgedriver";
            }

            log.info("This is the Edge driver path is :::: " + msedgeDriverPath);

            String absoluteEdgeDriverPath = toAbsolutePath(msedgeDriverPath);
            log.info("This is the edge driver real path is :::: " + absoluteEdgeDriverPath);

            System.setProperty("webdriver.edge.driver", absoluteEdgeDriverPath);
